...
\subsection{}
    ...
    \begin{enumerate}
        ...
        \item Give the minimum and maximum degree of the graph
        \item What is the degree of node 4?
        \item List the loops in this graph as a set
        \item Express a simple cycle in this graph as an ordered list
        \item Express a simple path that connects every node in this graph as an ordered list
        \item Express a shortest path connecting every even-numbered node as an ordered list
    \end{enumerate}
...
\subsection{}
    ...
    \begin{enumerate}
        ...
        \item The graph of the first 5 unique strings directed, connected, and/or cyclic?
    \end{enumerate}
